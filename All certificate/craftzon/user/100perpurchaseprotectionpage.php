...
<title>100% Purchase Protection - Craftzon</title>
...
<div class="container">
<div class="section">
    <p>At Craftzon, your safety and satisfaction are our top priorities. When you buy handmade products from our platform, we ensure that your purchase is protected from start to finish.</p>
  </div>
<div class="section">  
    <h2>How Our Purchase Protection Works:</h2>
    <ul>
        <li><strong>Secure Payments:</strong> All transactions are encrypted and securely processed.</li>
        <li><strong>Verified Sellers:</strong> Only registered and verified sellers can list their products.</li>
        <li><strong>Refund Policy:</strong> If the product doesn’t arrive or is not as described, you are eligible for a full refund.</li>
        <li><strong>Order Tracking:</strong> Track your product from the seller to your doorstep.</li>
        <li><strong>Customer Support:</strong> Our support team is available to resolve any issues quickly.</li>
    </ul>
</div>
<div class="section">
    <p>Buy with confidence and enjoy the unique handmade products on Craftzon without any worry. Your trust is important to us, and we guarantee a safe shopping experience every time!</p>
</div>
