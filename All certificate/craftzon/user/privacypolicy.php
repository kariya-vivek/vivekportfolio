...
<title>CraftZon Privacy Policy</title>
...
/* Header & Footer from About Us/Cookies Notice */
.header {
...
<div class="container">
    ...
    <p>Welcome to CraftZon, your dedicated platform for managing and showcasing handmade goods...</p>
    ...
    <ul>
        ...
        <li><strong>Payment Information:</strong> Credit card details, bank account information, etc.</li>
        <li><strong>Handmade Product Details:</strong> Descriptions, images, pricing, etc.</li>
        <li><strong>Communications:</strong> Messages, support inquiries, feedback, reviews.</li>
    </ul>

    <h3>1.2. Information We Collect Automatically:</h3>
    <ul>
        <li><strong>Log Data:</strong> IP address, browser type, OS, access times, pages viewed.</li>
        <li><strong>Device Information:</strong> Device type, unique IDs, network info.</li>
        <li><strong>Usage Data:</strong> How you interact with the Service.</li>
        <li><strong>Cookies and Tracking Technologies:</strong> For browsing activities and personalization.</li>
    </ul>

    <h3>1.3. Information from Third Parties:</h3>
    <p>We may receive information from social media, analytics, or marketing partners.</p>

    <h2>2. How We Use Your Information</h2>
    <ul>
        <li><strong>To Provide and Maintain the Service:</strong> Account, transactions, communication, deliveries.</li>
        <li><strong>To Improve and Personalize the Service:</strong> Understand usage, develop features, tailor content.</li>
        <li><strong>For Communication:</strong> Transactional emails, marketing (with consent), respond to inquiries.</li>
        <li><strong>For Security and Fraud Prevention:</strong> Detect and prevent fraud.</li>
        <li><strong>For Legal Compliance:</strong> Follow laws and regulations.</li>
        <li><strong>For Analytics and Research:</strong> Analyze trends, usage, and business improvements.</li>
    </ul>

    <h2>3. How We Share Your Information</h2>
    <ul>
        <li><strong>With Other Users:</strong> For transactions.</li>
        <li><strong>With Service Providers:</strong> Trusted third parties for processing and hosting.</li>
        <li><strong>For Legal Reasons:</strong> Required by law or to protect rights.</li>
        <li><strong>Business Transfers:</strong> In mergers or acquisitions.</li>
        <li><strong>With Your Consent:</strong> Explicit permission.</li>
        <li><strong>Aggregated or Anonymized Data:</strong> Market analysis or research.</li>
    </ul>

    <h2>4. Your Choices and Rights</h2>
    <ul>
        <li><strong>Access and Correction:</strong> Update your personal info.</li>
        <li><strong>Data Portability:</strong> Receive your data in a structured format.</li>
        <li><strong>Deletion:</strong> Request account/data deletion.</li>
        <li><strong>Marketing Communications:</strong> Opt-out of marketing emails.</li>
        <li><strong>Cookies:</strong> Adjust browser cookie settings.</li>
    </ul>

    <h2>5. Data Security</h2>
    <p>We implement reasonable measures to protect your personal information but cannot guarantee absolute security.</p>

    <h2>6. Data Retention</h2>
    <p>We retain personal info as long as necessary to provide services and comply with laws.</p>

    <h2>7. Children's Privacy</h2>
    <p>CraftZon is not for children under 16. We delete info collected from children under 16.</p>

    <h2>8. Changes to This Privacy Policy</h2>
    <p>We may update this Privacy Policy. Check the "Last Updated" date and review periodically.</p>

    <h2>9. Contact Us</h2>
    <div class="contact-info">
        <strong>CraftZon Support Team</strong>
        <p><strong>Email:</strong> <a href="craftzon25@gmail.com">craftzon25@gmail.com</a></p>
