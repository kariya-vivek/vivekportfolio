...
<title>Returns Centre - Craftzon</title>
...
<div class="container">
<div class="section">
    <p>Welcome to Craftzon's Returns Centre. We want you to shop with confidence. If you are not satisfied with your purchase, we are here to assist you with easy returns.</p>

    <h2>Return Policy Overview:</h2>
    <ul>
        <li>All handmade products can be returned within <strong>14 days</strong> of delivery.</li>
        <li>Items must be in their original condition and packaging.</li>
        <li>Refunds are processed to the original payment method within <strong>5-7 business days</strong> after receiving the returned item.</li>
        <li>Certain personalized items may not be eligible for return.</li>
        <li>Return shipping charges may apply, except in case of defective or incorrect items.</li>
    </ul>
</div>
<div class="section">
    <h2>How to Request a Return:</h2>
    <ol>
        <li>Login to your Craftzon account and go to <strong>My Orders</strong>.</li>
        <li>Select the order and click on <strong>Request a Return</strong>.</li>
        <li>Follow the instructions to generate a return label and shipping instructions.</li>
        <li>Ship the item back to us within the stipulated return period.</li>
    </ol>

    <p>If you have any questions or need assistance with your return, our support team is here to help you promptly.</p>
</div>
