...
<div class="container">
    ...
    <ul>
        <li><strong>How do I place an order?</strong> Browse products, add them to your cart, and complete the checkout process securely.</li>
        <li><strong>How can I contact the seller?</strong> Every product page has the seller's email listed. You can directly reach them for inquiries.</li>
        <li><strong>What if my product doesn’t arrive?</strong> Craftzon offers 100% Purchase Protection. Contact support for a refund.</li>
        <li><strong>Can I cancel an order?</strong> Orders can be canceled before they are shipped. Contact our support team immediately.</li>
        <li><strong>How do I advertise my products?</strong> Go to “Advertise Your Product” in your user panel and submit your product details.</li>
    </ul>
</div>
<div class="section">
    <h2>Contact Support</h2>
    <p>If you need further assistance, you can email us at <strong>craftzon25@gmail.com</strong> or reach out via our support form.</p>
</div>   
