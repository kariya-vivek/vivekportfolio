...
<title>Craftzon Merchant Commission</title>
...
<div class="header">
    <h1>Craftzon Merchant Commission</h1>
    <p>Fair and Transparent Commission for Sellers</p>
</div>

<div class="container-content">

    <div class="section">
        <h2>Commission on Delivered Orders</h2>
        <p>Craftzon charges a <strong>5% commission</strong> on the total value of every delivered order. This ensures that we only collect commission once the buyer has received the product and the transaction is complete, keeping the process fair for all sellers.</p>
        <img src='../deliverorder_commsion.png' alt="Merchant Payment">
    </div>

    <div class="section">
        <h2>Commission on Auction Starting Price</h2>
        <p>If a seller arranges an auction, Craftzon charges a <strong>5% commission</strong> on the starting price entered by the seller. This ensures that all auction-based sales contribute fairly to platform maintenance and services.</p>
        <img src='../auctionfee.png' alt="Auction Commission">
    </div>
