...
<title>CraftZon Cookies Notice</title>
...
<div class="container-content">
    <div class="section">
        ...
        <p>This Cookies Notice explains how CraftZon ("we," "us," or "our") uses cookies and similar technologies on our website and mobile applications (collectively, the "Service"). By continuing to use our Service, you are agreeing to our use of cookies in accordance with this notice.</p>
        ...
        <p>These cookies are essential to provide you with services available through our Service...</p>

        <h3>3.2. Performance and Analytics Cookies</h3>
        <ul>
            <li>Understand how our Service is used.</li>
            <li>Detect any errors and improve performance.</li>
            <li>Test different designs and features of our Service.</li>
        </ul>

        <h3>3.3. Functionality Cookies</h3>
        <p>These cookies allow our Service to remember choices you make when you use the Service...</p>
        ...
        <ul>
            ...
            <li><strong>Payment Processors:</strong> Fraud prevention</li>
            <li><strong>Advertising Partners:</strong> Personalized advertisements</li>
        </ul>

        <h2>5. Your Choices Regarding Cookies</h2>
        <p>You have the ability to accept or decline cookies...</p>

        <h2>6. Changes to This Cookies Notice</h2>
        <p>We may update our Cookies Notice from time to time...</p>
