...
<div class="mc" onclick="if(<?php echo isset($_SESSION['users_id']) ? $_SESSION['users_id'] : 0; ?> == 0) { Swal.fire({title: 'Login Required', text: 'Please login first!', icon: 'warning', showCancelButton: true, confirmButtonText: 'Login Now'}).then((result) => { if(result.isConfirmed) { window.location.href = 'logincraft.php'; } }); } else { document.getElementById('ordersForm').submit(); }" 
  ...
  My Orders
            ...
            <div class="mc active" onclick="window.location='abouuspage.php'" style="cursor:pointer; color:white; font-weight:400;">About Us</div>
...
<div class="container-content">
    ...
    <div class="section">
        <h2>Our Mission</h2>
        <p>At Craftzon, our mission is to empower local artisans by providing them a professional platform to showcase and sell their handmade crafts, bringing authentic Indian art to customers worldwide. We aim to blend tradition with modern technology, creating a seamless experience for buyers and sellers alike.</p>
    </div>

    <!-- Vision Section -->
    <div class="section">
        <h2>Our Vision</h2>
        <p>Our vision is to become the leading online marketplace for handmade crafts, fostering a global community of artisans and enthusiasts. We strive to preserve cultural heritage while promoting sustainable livelihoods and innovative craftsmanship.</p>
    </div>
...
<br>
        <div class="founders">
            <div class="founder-card">
                <img src='../aboutsimag1.png' alt="Kariya Vivek">
                <h5>Kariya Vivek</h5>
                <p>Co-Founder</p>
                <p>Email:<br>vivekkariya22@gmail.com</p>
            </div>
            <div class="founder-card">
                <img src='../sub.png' alt="Kartiya Shubham">
                <h5>Kartiya Shubham</h5>
                <p>Co-Founder</p>
                <p>Email:<br>kartiyashubham@gmail.com</p>
            </div>
        </div>
    </div>
    ...
    <div class="section">
        <h2>Contact Us</h2>
        <p>If you have any questions or suggestions, feel free to reach out to us at <a href="mailto:craftzon25@gmail.com">craftzon25@gmail.com</a>. We are always here to assist you and make your Craftzon experience exceptional.</p>
    </div>
